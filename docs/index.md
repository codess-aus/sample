...
title: Home
description: >-
  Practical AI workshops for leaders, students and young professionals —
...
<div class="hero" role="banner">
  <p class="hero-eyebrow">Education · Mentoring · Artificial Intelligence</p>
  <h1 class="hero-heading">Understand AI.<br>Ask Better Questions.<br>Create Real Impact.</h1>
  <p class="hero-sub">
...
<section id="workshops" class="chapter-grid-section" aria-label="Workshop chapters">
  <div class="chapter-grid">
    ...
    <a class="chapter-card" href="about/" aria-label="About the Educator – Introduction">
      <div class="chapter-card__img-wrap">
        <img
          ...
          alt="Educator speaking at a conference, empowering an audience"
      ...
      <div class="chapter-card__body">
        <span class="chapter-card__category">Introduction</span>
        ...
        <span class="chapter-card__link" aria-hidden="true">Explore chapter →</span>
      </div>
    </a>
    ...
    <a class="chapter-card" href="ai-for-leaders/" aria-label="AI for Leaders – For Leaders workshop">
      <div class="chapter-card__img-wrap">
        <img
          ...
          alt="Business leaders collaborating in a modern meeting room"
          width="640" height="360"
          loading="lazy"
          class="chapter-card__img"
        >
      ...
      <div class="chapter-card__body">
        <span class="chapter-card__category">For Leaders</span>
    ...
    <a class="chapter-card" href="philosophy/" aria-label="Understanding AI – Philosophy chapter">
      <div class="chapter-card__img-wrap">
        <img
          ...
          alt="Abstract representation of connected ideas and learning"
          width="640" height="360"
          loading="lazy"
          class="chapter-card__img"
        >
      ...
      <div class="chapter-card__body">
        <span class="chapter-card__category">Philosophy</span>
    ...
    <a class="chapter-card" href="industrial-problem-solving/" aria-label="Industrial Problem-Solving – For Students & Young Professionals">
      ...
      <div class="chapter-card__body">
        <span class="chapter-card__category">For Students &amp; Young Professionals</span>
    ...
    <a class="chapter-card" href="approach/" aria-label="Mentoring Today – Approach chapter">
      ...
      <div class="chapter-card__body">
        <span class="chapter-card__category">Approach</span>
    ...
    <a class="chapter-card" href="book-a-workshop/" aria-label="Book a Workshop – Get Started">
      ...
      <div class="chapter-card__body">
        <span class="chapter-card__category">Get Started</span>
